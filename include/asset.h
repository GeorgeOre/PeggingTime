...
/**
 * Renders the asset to the screen, scrolled about a player.
 * @param asset the asset to render
 * @param delta_scroll the amount the screen needs to scroll.
 */
 ...
 * Renders the asset to the screen, scrolled about a player.
 * @param asset the asset to render
 * @param angle the amount the asset needs to rotate
 */
