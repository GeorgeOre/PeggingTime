...
######   ENSCRIPTMEN TESTING MAKE FILE CODE   ######
...
######   LOCAL TESTING MAKE FILE CODE   ######

# List of C files in "libraries" and "demo" that you have written. Any additional files
# should be added here.
GAMES = game
SRCS = asset_cache asset body collision color emscripten forces list polygon scene sdl_wrapper vector UI being shape weapon projectile
TESTS = test
SERVERS = web_server
